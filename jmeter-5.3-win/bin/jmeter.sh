...
## This is a simple wrapper for the tools bin/jmeter
##
## Basic JMeter startup tools for Un*x systems
## See the "jmeter" tools for details of options that can be used for Sun JVMs
