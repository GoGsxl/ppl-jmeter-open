...
"""
 ...
 runant.py
    ...
    This tools is a translation of the runant.pl
    It runs ant with/out arguments, it should be quite portable (thanks to
    the python os library)
    This tools has been tested with Python2.0/Win2K

 Assumptions:

 - the "java" executable/tools is on the command path
"""
import os.path
import sys
...
# If ANT_HOME is not set default to tools's parent directory
